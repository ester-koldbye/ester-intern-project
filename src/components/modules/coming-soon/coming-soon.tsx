...
export const ComingSoon = ({
    ...
    return (
        <section
            ...
            className={cn(
                "px-padding-inline-mobile py-padding-block-mobile lg:px-padding-xl-inline lg:py-padding-xl-block flex w-full flex-col items-center gap-4 bg-white text-center",
                className,
            )}
            ref={ref}
            {...props}
