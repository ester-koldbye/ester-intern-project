...
export const FoodDrinks = ({
    ...
    return (
        <section
            ...
            className={cn(
                "py-padding-block-mobile px-padding-inline-mobile md:py-padding-m-block md:px-padding-m-inline lg:py-padding-xl-block lg:px-padding-xl-inline flex w-full flex-col items-center gap-12 bg-white lg:gap-20",
                className,
            )}
            ref={ref}
            {...props}
